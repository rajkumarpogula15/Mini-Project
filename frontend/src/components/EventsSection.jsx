...
const dummyEvents = [
  {
    ...
    type: 'Workshop',
    tags: ['AI', 'Beginner'],
    thumbnail: 'https://th.bing.com/th/id/OIP.jRzssFPcy9aIA8EzcNdKjwHaEK?rs=1&pid=ImgDetMain',
  },
  {
    id: 2,
    ...
    thumbnail: 'https://th.bing.com/th/id/OIP.cJaWu8oluj9QSwAlsad3LwHaEo?rs=1&pid=ImgDetMain',
  },
  {
    id: 3,
        ...
        {dummyEvents.map((event) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className="w-full bg-indigo-600 text-white text-sm py-1.5 rounded hover:bg-indigo-700 transition">
                Register
              </button>
            </div>
          </div>
